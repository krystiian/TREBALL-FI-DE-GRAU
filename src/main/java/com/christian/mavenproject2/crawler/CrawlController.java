...
public class CrawlController extends Configurable {
	...
	public CrawlController(CrawlConfig config, PageFetcher pageFetcher, RobotstxtServer robotstxtServer, mainMenu menu)
			throws Exception {
		super(config);
	...
	public void addSeed(String pageUrl, int docId) {
		...
		if (canonicalUrl == null) {
			...
			if (robotstxtServer.allows(webUrl)) {
				...
				// using the WARN level here, as the user specifically asked to
				// add this seed
