 ...
 *
 * FormAuthInfo contains the authentication information needed for FORM
 * authentication (extending AuthInfo which has all common auth info in it)
 * Basically, this is the most common authentication, where you will get to a
 * site and you will need to enter a username and password into an HTML form
 */
public class FormAuthInfo extends AuthInfo {
	 ...
	 * @param loginUrl
	 *            Full login URL, starting with "http"... ending with the full
	 *            URL
	 * @param usernameFormStr
	 *            "Name" attribute of the username form field
	 * @param passwordFormStr
	...
	/**
	 * @param usernameFormStr
	 *            username html "name" form attribute
	 */
