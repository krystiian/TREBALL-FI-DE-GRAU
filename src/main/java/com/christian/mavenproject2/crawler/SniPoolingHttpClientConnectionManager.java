...
/**
 * Class to work around the exception thrown by the SSL subsystem when the
 * server is incorrectly configured for SNI. In this case, it may return a
 * warning: "handshake alert: unrecognized_name". Browsers usually ignore this
 * warning, while Java SSL throws an exception.
 *
 * This class extends the PoolingHttpClientConnectionManager to catch this
 * exception and retry without the configured hostname, effectively disabling
 * the SNI for this host.
 *
